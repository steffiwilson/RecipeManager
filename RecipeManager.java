...
public class RecipeManager extends javax.swing.JFrame{
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(RecipeNameLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 343, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void initAddRecipe(final int RecipeID) {
       ...
       String[][] subcategories = listSubCategories();
        ...
        messurementTypeTextField.setText("Mesurement Type");
        ...
        cookTimeLabel.setText("Time To Cook");
 ...
 // </editor-fold>                        
    ...
    private void AddRecipeActionPerformed(java.awt.event.ActionEvent evt) {                                         
     ...
     String recipeIngredients[][] = listIngredients(RecipeID);
        ...
        for(int i = 0; i < recipeIngredients.length; i++)
            strings[i] = recipeIngredients[i][1] + " " + recipeIngredients[i][2] + " " + recipeIngredients[i][0];
     ...
     private void addIngredientButtonActionPerformed(java.awt.event.ActionEvent evt) {                                           
       if(!(((String)IngredentTextField.getText()).matches("Enter Ingredient")) && 
            ...
            ArrayList<String> IngredientList = new ArrayList<String>();
                ...
                IngredientList.add((String)messurementTypeTextField.getText());                 
                IngredientList.add(null);
            IngredientsOfLists.add(IngredientList);
            stringIngredientList.add(messuremnt + " " + (String)messurementTypeTextField.getText() + " " + (String)IngredentTextField.getText());
        }
       updateIngredients();
       IngredentTextField.setText("Enter Ingredient");
    }  
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt, final int RecipeID) {                                           
        ...
        else if((((String)messurementTypeTextField.getText()).matches("Mesurement Type")))        
            errorBoxLabel.setText("Enter a valid Messurement Type");
    ...
    private void selectButtonActionPerformed(java.awt.event.ActionEvent evt) {                                         
       int selectedRecipeID = Integer.parseInt((String)(resultsTable.getModel().getValueAt(resultsTable.getSelectedRow(), 0)));
        ...
        //System.out.println(sqlGetRecipeId);
         resultset = execSQLSingleColumnSelect(sqlGetRecipeId);
            ...
            if ( resultset.length > 0) { 
                //we found a matching recipe, so this is not a new recipe
                isNewRecipe = false;
